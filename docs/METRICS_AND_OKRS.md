...
### 2.9 Global table matrix reliability

**What it measures:**  
Share of Global Analytics table loads that return non-empty rows without `global-table-empty`, and UHC cell fill rate when WDI is sparse.
