...
- [ ] Global Analytics WLD charts: accordion lazy load; partial/null warnings; debt US$ panel method
- [ ] Assistant: “What is world GDP?” uses WLD block; country digests skip `wld_proxy` preference
